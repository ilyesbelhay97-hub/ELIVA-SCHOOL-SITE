...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; slug: string }> }): Promise<Metadata> {
  ...
  return { title: title + " | Meritify Academy", description, alternates: { canonical: "/" + locale + "/formations/" + slug, languages: { fr: "/fr/formations/" + slug, ar: "/ar/formations/" + slug } }, openGraph: { title, description, images: course?.cover_image_path ? [course.cover_image_path] : undefined } };
}
