...
export const metadata: Metadata = { title: "S’inscrire à une formation | Meritify Academy", description: "Préparez votre demande d’inscription à une formation Meritify Academy." };
